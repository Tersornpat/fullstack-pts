                            ...
                            <td valign=top>
                                <table width=100% height=15% border=0>
                                    <tr >
                                        ...
                                        <td width=20% rowspan=2 valign=bottom><div style=" text-align: center;">หมายเลข Order</div></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td width=20% valign=top align=center style="font-size:30px" rowspan=2><div style=" text-align: center;"><?php echo $a["Order_ID"]; ?></div></td>
                                    </tr>
                                    <tr>
                                ...
                                <table width=100% height=75%>
                                    ...
                                    <?php
                                        ...
                                        echo "
                                            ...
                                            <tr valign=center align='center' height=35px>

                                                        <td colspan='5'> TOTAL </td>
                                                        <td>".$a['total_order_price']."</td>
                                            </tr>            ";
                                    ?>
                                </table>
                            </td>
